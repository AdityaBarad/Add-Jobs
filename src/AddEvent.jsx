...
export default function AddEvent() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const { custom_location, location, registration_type, prize_pool, start_date, end_date, ...rest } = form;
  ...
  <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '15px' }} aria-label="Event Form">
        ...
        <input id="event-start-date" className="form-control" name="start_date" type="date" placeholder="Start Date" value={form.start_date} onChange={handleChange} required aria-required="true" aria-label="Start Date" />
        <label htmlFor="event-end-date">End Date</label>
        <input id="event-end-date" className="form-control" name="end_date" type="date" placeholder="End Date" value={form.end_date} onChange={handleChange} required aria-required="true" aria-label="End Date" />
