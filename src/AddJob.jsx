...
export default function AddJob() {
  const [form, setForm] = useState({
    // Required fields with string validation
    title: '',
    company_name: '',
    company_website: '',
    category: 'IT',
    ...
    stipend_salary: '',
    duration: '',
    deadline: '', // This will map to application_deadline in the DB
    company_logo: '',
    apply_link: '',
    description: '',
    requirements: '',
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      // Create the job data object with exact matching fields from DB
      const jobData = {
        ...
        stipend_salary: form.stipend_salary.trim() || null,
        duration: form.duration.trim() || null,
        application_deadline: form.deadline || null,  // Changed from deadline to application_deadline
        company_logo: form.company_logo || null,
        apply_link: form.apply_link.trim() || null,
        description: form.description.trim() || null,
        requirements: form.requirements.trim() || null,
        source: form.source || window.location.origin,
        status: form.status || 'active',
        skills_required: form.skills_required.split(',').map(s => s.trim()).filter(Boolean),
        location: form.location === 'Other' ? form.custom_location : form.location,
        created_at: new Date().toISOString(),  // Changed from posted_date to created_at
